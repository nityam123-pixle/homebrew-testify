class Testify < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/nityam123-pixle/testify-cli/releases/download/v1.2.10/testify_darwin_arm64.tar.gz"
      sha256 "0faf7c90844d709be7556868ff169a13ac756df11caf83315387b790c763b078"
    end
    on_intel do
      url "https://github.com/nityam123-pixle/testify-cli/releases/download/v1.2.10/testify_darwin_amd64.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/nityam123-pixle/testify-cli/releases/download/v1.2.10/testify_linux_arm64.tar.gz"
      sha256 "d2b77303b22472384ec553b244b02638cd30b2dbbbf037a0d90f89d6600fcc0b"
    end
    on_intel do
      url "https://github.com/nityam123-pixle/testify-cli/releases/download/v1.2.10/testify_linux_amd64.tar.gz"
